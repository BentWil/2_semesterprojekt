...
//
// _coder_fkfunc_info.cpp
//
// Code generation for function 'fkfunc'
//

// Include files
#include "_coder_fkfunc_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("fkfunc"));
...
// End of code generation (_coder_fkfunc_info.cpp)
