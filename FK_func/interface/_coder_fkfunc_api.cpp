...
//
// _coder_fkfunc_api.cpp
//
// Code generation for function 'fkfunc'
//

// Include files
#include "_coder_fkfunc_api.h"
#include "_coder_fkfunc_mex.h"
                ...
                const mxArray *plhs[2])
{
  ...
  fkfunc(*P, *Gorg, theta, *outputArg1, *outputArg2);
...
// End of code generation (_coder_fkfunc_api.cpp)
